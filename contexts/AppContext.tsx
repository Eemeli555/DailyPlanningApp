I'll help you merge the changes and generate the complete updated file. The main changes include:

1. Adding new types and interfaces for sleep data, social media usage, productive activities, etc.
2. Adding new state variables and functions for managing these features
3. Expanding the journal entry interface with more fields
4. Adding analytics and dashboard metric functionality
5. Updating the context provider with new values and functions
