...
const ScheduleTaskModal = ({ 
  ...
  const handleSchedule = () => {
    if (!item || !selectedTimeSlot) return;
    ...
    >
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.title}>Schedule {itemType === 'task' ? 'Task' : 'Activity'}</Text>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.itemInfo}>
            <View style={styles.itemHeader}>
              {itemType === 'activity' && item.icon && (
                <Text style={styles.itemIcon}>{item.icon}</Text>
              )}
              <View style={styles.itemDetails}>
                <Text style={styles.itemTitle}>
                  {itemType === 'task' ? item.title : item.name}
                </Text>
                {item.description && (
        ...
        <View style={styles.footer}>
          ...
          />
          <Button
            title={`Schedule ${itemType === 'task' ? 'Task' : 'Activity'}`}
